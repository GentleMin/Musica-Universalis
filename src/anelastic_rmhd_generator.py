...
def main_anelastic_rmhd_setup():
    ...
    print("============================================================================================")
    print("                        Anelastic rotating MHD eigenvalue problem                           ")
    ...
    # Background fields
    B0 = bgs.MagBG_SolarTa_pro(Ro=Ro)
    # B0 = bgs.MagBG_T2_Linear(Ri, Ro, Bi=1, Bo=0.5)
    U0 = bgs.SolarDiffRot_SHT_LSQ(Ro, L=16, Nr=9)
    rho0 = bgs.LinearProfile(Ri=Ri, Ro=Ro, fi=1, fo=1)

    # Model
    model_rmhd = evp_shell.ModelEVP_AnelasticMDRShell_TorPol((Ri, Ro), (N, L, m), B0_func=B0, U0_func=U0, rho0_func=rho0)
